...
const Client = ({ client }: any) => {
  ...
  return (
    <div className="group px-6 py-4 border border-gray-300 hover:border-blue-900 rounded-md hover:outline-1 w-full max-w-sm">
      <h2 className="font-semibold group-hover:text-blue-900 text-lg">
        {name}
      </h2>
